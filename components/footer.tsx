    ...
    <footer className="bg-slate-900 text-white py-16 px-4">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center mb-4">
              <Image src="/interroom-logo.png" alt="Interroom" width={120} height={40} className="h-8 w-auto" />
            </Link>
            <p className="text-slate-400 text-sm leading-relaxed">
              We help professionals land their dream jobs through personalized coaching, automated applications, and
              expert guidance.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">© 2024 Interroom. All rights reserved.</p>
