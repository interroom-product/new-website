    ...
    <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-violet-50 to-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl md:text-5xl lg:text-6xl font-medium leading-tight mb-6">
            ...
            <div>
              <Link href="/survey">
                <Button
                  size="lg"
                  className="bg-violet-600 hover:bg-violet-700 text-lg px-8 py-4 h-auto w-full sm:w-auto"
                >
                  Unlock My Next Career Move <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
            </div>
          </div>
