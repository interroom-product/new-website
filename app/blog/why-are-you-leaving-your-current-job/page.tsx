            ...
            <div className="p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 mb-6">
                  They want to understand your motivations, assess potential red flags (like job hopping, conflict
                  issues, negativity), and see if your reasons align with what their company can offer.
                </p>
                ...
                <p className="text-gray-700 mb-4">
                  Frame your departure as a step towards growth, new opportunities, or a better fit for your
                  skills/goals.
                </p>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">
                  Highlight growth or career development:
                </h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                  <p className="text-gray-800">
                    <strong>Example:</strong> "I've gained valuable experience at [current company], but I'm ready to
                    take on greater responsibilities and contribute in new ways that this role seems to offer."
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                  <p className="text-gray-800">
                    <strong>Example:</strong> "While I've enjoyed my time, there are limited opportunities for
                    advancement in my current role, and I'm eager to take the next step in my career."
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                  <p className="text-gray-800">
                    <strong>Example:</strong> "My position was eliminated as part of a company-wide downsizing." (If
                    asked for more detail, keep it concise and neutral).
                  </p>
                </div>
                ...
                <ul className="list-disc pl-6 mb-6 text-gray-700">
                  ...
                  <li className="mb-2">
                    Complaining about minor issues (long hours, commute, salary - unless handled strategically when
                ...
                <ol className="list-decimal pl-6 mb-6 text-gray-700">
                  ...
                  <li className="mb-2">
                    <strong>Reframe:</strong> Turn any negative reasons into positive desires for the future
                    role/company.
                  </li>
                  <li className="mb-2">
