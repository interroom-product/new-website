...
export default function WhyLeavingJobPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <article className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Focus on the positive/future:</h3>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <p className="text-gray-700 italic">
                ...
                position." or "I'm seeking a company culture that aligns more closely with [values, e.g., collaboration,
                innovation]."
              </p>
            </div>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Highlight growth or career development:</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Discuss lack of opportunity:</h3>
            <p className="text-gray-700 leading-relaxed mb-4">If growth or promotion isn't possible.</p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <p className="text-gray-700 italic">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Mention company changes:</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Address a layoff:</h3>
            <p className="text-gray-700 leading-relaxed mb-4">Be straightforward and brief.</p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <p className="text-gray-700 italic">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Explain relocation (if applicable):</h3>
            <p className="text-gray-700 leading-relaxed mb-4">Simple and factual.</p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <p className="text-gray-700 italic">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">If dissatisfied (use caution!):</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              Frame it constructively. Instead of "My boss was terrible," say "I'm seeking a role with a different
              management style that emphasizes [specific positive aspect]." Instead of "I hated the culture," say "I'm
              looking for a culture that is more [describe the positive culture you seek]."
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6">
              <li>Badmouthing your current/former employer, boss, or colleagues.</li>
              <li>
              ...
              <li>Giving vague or evasive answers.</li>
              <li>Lying (it can come back to haunt you).</li>
            </ul>
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-6 mt-8">
              <p className="text-gray-700 font-medium">
                <strong>Key Takeaway:</strong> By preparing a thoughtful, positive, and professional answer, you can
                turn this potentially tricky question into an opportunity to highlight your ambition and suitability for
                the new role.
              </p>
            </div>
          </div>
